...
public class RunPackedWork {
	...
	public static void main(String[] args) {
		...
		var futures =
				IntStream.range(0, 10 * CPU_COUNT)
				.mapToObj(i -> CompletableFuture.supplyAsync(Work::runw, Workers.cachedThreadPool))
//				.mapToObj(i -> CompletableFuture.supplyAsync(Work::runw, Workers.fixedThreadPool))  // PT2M46.777S
				.toList();
